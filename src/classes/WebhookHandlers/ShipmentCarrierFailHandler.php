...
/**
 * Class ShipmentCarrierFailHandler
 *
 * @package Packlink\PrestaShop\Classes\WebhookHandlers
 */
class ShipmentCarrierFailHandler extends WebhookHandler
{
    /**
    ...
    public function handle($payload)
    {
        ...
        // $this->eventBus->fire(new ShipmentStatusChangedEvent($payload->shipment_reference));
    }
}
