...
/**
 * Class ShipmentCarrierSuccessHandler
 *
 * @package Packlink\PrestaShop\Classes\WebhookHandlers
 */
class ShipmentCarrierSuccessHandler extends WebhookHandler
{
    /**
    ...
    {
        $this->eventBus->fire(
            new ShipmentStatusChangedEvent($payload->shipment_reference, ShipmentStatusChangedEvent::STATUS_ACCEPTED)
        );
    }
}
